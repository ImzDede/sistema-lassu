...
export default function AnamnesePage() {
  ...
  useEffect(() => {
    if (selectedPatient) {
      fetchForm("ANAMNESE", selectedPatient);
    }
    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto w-full relative pb-20">
      <div className="flex items-center gap-4">
        ...
        <div>
          <Typography
            variant="h4"
            className="font-bold uppercase tracking-wide text-brand-anamnese"
          >
            {mode === "view" ? "Visualizar Anamnese" : "Anamnese"}
          </Typography>
        ...
        <CardBody className="p-0">
          <div className="p-6 md:p-10 border-b border-gray-100 bg-gray-50/50">
            <div className="flex items-center gap-3 mb-6 pb-6 border-b border-gray-200">
              ...
              <Typography
                variant="h6"
                className="font-bold text-brand-anamnese"
              >
                Dados da Anamnese
              </Typography>
            </div>
          ...
          <div className="px-6 md:px-10 py-8">
            {!selectedPatient ? (
              ...
              <div className="flex justify-center py-10">
                <Spinner className="h-8 w-8 text-brand-anamnese" />
              </div>
            ) : formData ? (
              <FormularioBuilder
