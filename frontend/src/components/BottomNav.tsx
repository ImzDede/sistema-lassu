...
export default function BottomNav({ user }: BottomNavProps) {
  ...
  const navItems = [
    { href: "/home", icon: Home, label: "Início", show: true },
    {
      href: "/home/pacientes",
      icon: Users,
      label: "Pacientes",
    ...
    },
    {
      ...
      icon: Users,
      label: "Terapeutas",
      show: canAccessTherapists, // ✅
    },
    { href: "/home/cadastro", icon: PlusSquare, label: "Cadastro", show: true },
    { href: "/home/perfil", icon: UserIcon, label: "Perfil", show: true },
  ];
